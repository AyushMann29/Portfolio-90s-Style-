...
let castlelocation = { x: 1300, y: 200 };
let universitylocation = { x: 500, y: 200 };
tc.style.left = `${tclocation.x}px`;
tc.style.top = `${tclocation.y-10}px`;
castle.style.left = `${castlelocation.x-100}px`;
castle.style.top = `${castlelocation.y-150}px`;
...
function checkCollision(obj1, obj2) {
    ...
    const hitboxSize = 700; // Increase this value to make the hitbox larger
    const rect2Adjusted = {
